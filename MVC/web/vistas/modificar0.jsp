...
<html>
    ...
    <body>
        ...
        <div class="container2">
            <div class="col-xs-7">
        <div class="container">
            <form action="Modificar0" id="Modificar00">
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <input class="<% 
                            if(errorNombreUsuario != null ){
                                if(!errorNombreUsuario.equals("")){out.println("error");
                            }
                        }
       ...
       <script>
       $(document).on("submit","#Modificar00",function( event ) {
              ...
              var $form = $( this ),
                ...
                Modificar0 = $form.attr( "action" );
                var posting = $.post( "Modificar0", { nombreusuario:nombreusuario, contrasena:contrasena , nombre:nombre,telefono:telefono,email:email,direccion:direccion,apellido:apellido} );
                posting.done(function( respuestaJson ) {
                   ...
                   contenidotabla +=
                        ...
                        "<div class='row'>"+
                            ...
                            "</div>"+
                            "<div class='col-xs-4'>"+
                                "<input class='"+usuario.errorNombreUsuario+"'type='text' name='nombreusuario' value='"+usuario.nombreUsuario+"'/>"+
                            "</div>"+
                        "</div>"+
                        ...
                        "<div class='row'>"+
                            ...
                            "</div>"+
                            "<div class='col-xs-4'>"+
                                "<input class='"+usuario.errorNombre+"'type='text' name='nombre' value='"+usuario.nombre+"'/>"+
                            "</div>"+
                        "</div>"+
                        ...
                        "<div class='row'>"+
                            ...
                            "</div>"+
                            "<div class='col-xs-4'>"+
                                "<input class='"+usuario.errorApellido+"' type='text' name='apellido' value='"+usuario.apellido+"'/>"+
                            "</div>"+
                        "</div>"+
                        ...
                        "<div class='row'>"+
                            ...
                            "</div>"+
                            "<div class='col-xs-4'>"+
                                "<input class='"+usuario.errorDireccion+"' type='text' name='direccion' value='"+usuario.direccion+"'/>"+
                            "</div>"+
                        "</div>"+
                        ...
                        "<div class='row'>"+
                            ...
                            "</div>"+
                            "<div class='col-xs-4'>"+
                                "<input class='"+usuario.validaTel+"' type='text' name='telefono' value='"+usuario.telefono+"'/>"+
                            "</div>"+
                        "</div>"+
                        ...
                        "<div class='row'>"+
                            ...
                            "</div>"+
                            "<div class='col-xs-4'>"+
                                "<input class='"+usuario.validaEm+"' type='text' name='email' value='"+usuario.email+"'/>"+
                            "</div>"+
                        "</div>"+
                        ...
                        "<div class='row'>"+
                            ...
                            "</div>"+
                            "<div class='col-xs-4'>"+
                                "<input class='"+usuario.errorContraseña+"' type='password' name='contrasena' value='"+usuario.contrasena+"'/>"+
                            "</div>"+
                        "</div>"+
